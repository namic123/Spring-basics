...
public class Controller17 {
    @Autowired
    private ServletContext application; // 임시 데이터베이스
    ...
    public void list(Model model) {
        ...
        System.out.println("Controller17.list");
    }

    @GetMapping("new")
    public void newPost() {
        System.out.println("Controller17.newPost-GetMapping");
    }
    ...
    public void view(Integer id, Model model) {
        ...
        System.out.println("Controller17.view");
    }
}
