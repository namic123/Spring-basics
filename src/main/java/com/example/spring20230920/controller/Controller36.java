...
*/
    ...
    */
    ...
    /*
    axios.delete("/main36/sub9")
    PathVariable을 쓰면 메서드의 파라미터가 url 경로에 붙음
    axios.delete("/main36/sub9/son")
    */
    // PathVariable : 경로에 포함된 데이터
    @DeleteMapping("sub9/{name}")   // PathVariable 명과 동일해야함.
    ...
    */
    ...
    public void method12(@PathVariable Integer pid) {
        int n = dao.deleteByEmployeeId(pid);
